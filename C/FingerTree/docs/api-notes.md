...
- persistent sorted set and sorted multiset wrappers using a runtime comparator;
...
- sorted map, generic endpoint interval tree, measured rope chunks, and samples/benchmarks;
