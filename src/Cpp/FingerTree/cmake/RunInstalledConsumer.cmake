...
set(build_command "${CMAKE_COMMAND}" --build "${consumer_binary_dir}" --parallel 1)
if(DEFINED FINGERTREE_CONFIGURATION AND NOT FINGERTREE_CONFIGURATION STREQUAL "")
...
set(test_command "${FINGERTREE_CTEST_COMMAND}" --test-dir "${consumer_binary_dir}" --parallel 1 --output-on-failure)
if(DEFINED FINGERTREE_CONFIGURATION AND NOT FINGERTREE_CONFIGURATION STREQUAL "")
