...
lineCount rope
  | totalNewlines == maxBound =
      error "Data.Structures.FingerTree.Rope.Text: line count overflow"
...
lineColumnOfCursor cursorValue =
  case lineColumnOf (cursorPosition cursorValue) (snapshot cursorValue) of
    Just value -> value
    Nothing -> error "Data.Structures.FingerTree.Rope.Text.lineColumnOfCursor: invalid cursor invariant"
