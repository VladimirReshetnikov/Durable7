...
| --- | --- | --- |
| [Hamt](Hamt/README.md) | `tools-data-structures-hamt` | `Data.Structures.Hamt`; `Data.Structures.Hamt.HashMap` with one-descent persistent factories; `Data.Structures.Hamt.HashBag`; `Data.Structures.Hamt.BiMap`; `Data.Structures.Hamt.HashSet`; `Data.Structures.Hamt.Transient` |
