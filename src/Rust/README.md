...
parity port: operations are immutable and persistent, but several facades currently rebuild shared
snapshots instead of using the lazy finger-tree spine. Its README marks that boundary so future work
can replace the representation without changing the Rust-facing surface.
