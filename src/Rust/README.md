...
| [FingerTree](FingerTree/README.md) | Rust checkpoint for the FingerTree family, positional rope cursor, and mutable DABA Lite FIFO-window aggregator | `tools_data_structures_fingertree::*` | `.\test.ps1 -Workspace FingerTree` |
...
changing the Rust-facing surface. The positional `RopeCursor<T>` likewise preserves gap/edit/branch
semantics through a root-sharing rope snapshot without claiming the C# zipper representation or its
focus-local complexity.
