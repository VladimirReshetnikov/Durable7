// Persistent Wolfram-List-shaped sequence facade over the FingerTree deque core.
//
...
/// <summary>
/// An immutable, persistent ordered sequence shaped for representing a Wolfram Language
...
/// classic Wolfram append-in-a-loop trap (quadratic list growth) costs O(n) total here along a
/// linear history.
/// </para>
/// <para>
/// Indexing is zero-based throughout, following .NET convention; the corresponding Wolfram
/// <c>Part</c> positions are one-based. Wolfram operation correspondence:
...
public sealed class PersistentList<T> : IReadOnlyList<T>
{
    ...
    /// <summary>
    /// Gets the number of elements. Wolfram: <c>Length</c>.
    /// </summary>
    /// <remarks>O(1).</remarks>
    ...
    /// <summary>
    /// Gets the first element. Wolfram: <c>First</c>.
    /// </summary>
    ...
    /// <summary>
    /// Returns a list with an element added at the back. Wolfram: <c>Append</c>.
    /// </summary>
    ...
    /// <summary>
    /// Returns a list with an element added at the front. Wolfram: <c>Prepend</c>.
    /// </summary>
    /// <param name="item">Element to add.</param>
    ...
    /// <summary>
    /// Returns a list with a sequence appended at the back. Wolfram: <c>Join</c> with a
    ...
    /// <summary>
    /// Returns the concatenation of this list and another persistent list. Wolfram: <c>Join</c>.
    /// </summary>
    ...
    /// <summary>
    /// Returns a list with an element inserted before the specified zero-based index. Wolfram:
    ...
    /// <summary>
    /// Returns a list with the element at a zero-based index removed. Wolfram: <c>Delete</c>
    /// (one-based there).
    /// </summary>
    /// <param name="index">Zero-based element index.</param>
    ...
    /// <summary>
    /// Returns a list with the first element removed. Wolfram: <c>Rest</c>.
    /// </summary>
    /// <returns>A new list one element shorter; the source is unchanged.</returns>
    /// <remarks>O(1) amortized, O(log n) worst-case.</remarks>
    /// <exception cref="InvalidOperationException">The list is empty.</exception>
    ...
    /// Wolfram: <c>MapAt</c> (one-based there).
    /// </summary>
    /// <param name="index">Zero-based element index.</param>
    ...
    /// <summary>
    /// Returns the contiguous sub-list starting at a zero-based index. Wolfram: <c>Part</c>
    ...
    /// <summary>
    /// Returns the first <paramref name="count"/> elements. Wolfram: <c>Take[list, count]</c>.
    /// </summary>
    ...
    /// <summary>
    /// Returns the last <paramref name="count"/> elements. Wolfram: <c>Take[list, -count]</c>.
    /// </summary>
    ...
    /// <summary>
    /// Returns the list without its first <paramref name="count"/> elements. Wolfram:
    /// <c>Drop[list, count]</c>.
    /// </summary>
    ...
    /// <summary>
    /// Returns the list without its last <paramref name="count"/> elements. Wolfram:
    /// <c>Drop[list, -count]</c>.
    /// </summary>
    ...
    /// <summary>
    /// Returns the list with element order reversed. Wolfram: <c>Reverse</c>.
    /// </summary>
    /// <returns>A new list; the source is unchanged.</returns>
    /// <remarks>
    /// O(n), matching the reference Wolfram cost. A wrapper-level reversal bit would make this
    ...
    /// <summary>
    /// Returns the list with a pure function applied to every element. Wolfram: <c>Map</c>.
    /// </summary>
    ...
    /// <summary>
    /// Finds the zero-based index of the first occurrence of an element. Wolfram:
    ...
    /// <summary>
    /// Determines whether the list contains an equal element. Wolfram: <c>MemberQ</c>.
    /// </summary>
    /// <param name="item">Element to locate.</param>
    /// <param name="comparer">Equality comparer, or <see langword="null"/> for <see cref="EqualityComparer{T}.Default"/>.</param>
