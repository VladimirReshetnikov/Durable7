...
using FtSortedDictionary = Tools.DataStructures.FingerTree.SortedDictionary<int, string>;
...
public sealed class SortedBuilderTests
{
    ...
    public void SortedSetBuilder_PreservesComparerAndRepresentatives()
    {
        ...
        var set = Tools.DataStructures.FingerTree.SortedSet<string>.CreateRange(new[] { "aa" }, byLength);
    ...
    {
        var builder = Tools.DataStructures.FingerTree.SortedDictionary<string?, int>.CreateBuilder(Comparer<string?>.Default);
