...
- Scope: xUnit and CsCheck test project under `src/CSharp/tests/Durable7.Tungsten.Tests`

`Durable7.Tungsten.Tests` is the managed test project for the C# Tungsten-collections
library. It targets the workspace defaults from `Directory.Build.props`, references the public
`Durable7.Tungsten` project, and uses xUnit, `Microsoft.NET.Test.Sdk`,
