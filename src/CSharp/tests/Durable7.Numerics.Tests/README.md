...
- Scope: xUnit test project under `src/CSharp/tests/Durable7.Numerics.Tests`

`Durable7.Numerics.Tests` targets the workspace defaults from `Directory.Build.props`, references the public
`Durable7.Numerics` project, and uses xUnit, `Microsoft.NET.Test.Sdk`, and `xunit.runner.visualstudio`.
