...
`D7_BENCHMARK_IN_PROCESS=1` to select BenchmarkDotNet's no-emit in-process toolchain. This mode
...
For `MeasuredRopeCursorQueryBenchmarks`, set `D7_AXIS2_C2_GATE_ONLY=1` to restrict the document-size
