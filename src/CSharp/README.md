...
| [Ordered](docs/Ordered/overview.md) | Independent insertion-ordered persistent set over the public HAMT and FingerTree substrates, with explicit movement, positional ranges, stable one-shot sorting, and receiver-comparer algebra | [project](src/Tools.DataStructures.Ordered/Tools.DataStructures.Ordered.csproj), [usage](docs/Ordered/usage.md), [API spec](docs/Ordered/api-specification.md), [validation](docs/Ordered/validation.md) | `.\test.ps1`; see [tests](tests/Tools.DataStructures.Ordered.Tests/README.md) |
