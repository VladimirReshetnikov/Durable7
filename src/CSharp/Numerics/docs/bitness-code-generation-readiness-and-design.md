...
- Scope: `src/CSharp/Numerics/src/Tools.Numerics` wide-integer family (`Int256/512/1024`, `UInt256/512/1024`) and corresponding tests in `src/CSharp/Numerics/tests/Tools.Numerics.Tests`
- Related code:
  ...
  - `src/CSharp/Numerics/tests/Tools.Numerics.Tests/MixedScenarios/DeclarationParityTests.cs`
  - `src/CSharp/Numerics/tests/Tools.Numerics.Tests/MixedScenarios/PublicApiCoverageTests.cs`
- Related docs:
  - `src/CSharp/Numerics/README.md`
  - `src/CSharp/Numerics/tests/Tools.Numerics.Tests/README.md`
  - `src/CSharp/Numerics/docs/wide-integer-maintainer-guidance.md`
