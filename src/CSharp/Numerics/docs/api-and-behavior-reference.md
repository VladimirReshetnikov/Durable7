...
- Scope: Public behavior and compatibility contract for `src/CSharp/Numerics/src/Tools.Numerics`
- Related code:
  - `src/CSharp/Numerics/src/Tools.Numerics/UInt256.cs`
  - `src/CSharp/Numerics/src/Tools.Numerics/Int256.cs`
  - `src/CSharp/Numerics/src/Tools.Numerics/UInt512.cs`
  - `src/CSharp/Numerics/src/Tools.Numerics/Int512.cs`
  - `src/CSharp/Numerics/src/Tools.Numerics/UInt1024.cs`
  - `src/CSharp/Numerics/src/Tools.Numerics/Int1024.cs`
  - `src/CSharp/Numerics/src/Tools.Numerics/SparseInteger.cs`
  - `src/CSharp/Numerics/src/Tools.Numerics/SparseInteger.Conversions.cs`
  - `src/CSharp/Numerics/src/Tools.Numerics/BitConverterEx.cs`
  - `src/CSharp/Numerics/src/Tools.Numerics/BitHelpers.cs`
  - `src/CSharp/Numerics/src/Tools.Numerics/NumericParseHelpers.cs`
  - `src/CSharp/Numerics/src/Tools.Numerics/ArrayHelpers.cs`
- Related tests:
  - `src/CSharp/Numerics/tests/Tools.Numerics.Tests/BitWidth256/*`
  - `src/CSharp/Numerics/tests/Tools.Numerics.Tests/BitWidth512/*`
  - `src/CSharp/Numerics/tests/Tools.Numerics.Tests/BitWidth1024/*`
  - `src/CSharp/Numerics/tests/Tools.Numerics.Tests/MixedScenarios/*`
- Related docs:
...
- Project overview: [workspace README](../README.md)
