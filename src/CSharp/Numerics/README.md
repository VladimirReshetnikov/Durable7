...
- Scope: Project layout, API orientation, documentation, and validation entry points for `src/CSharp/Numerics`
...
- `Numerics.sln` is the solution entry point.
...
- [`docs/`](docs/README.md) contains the API reference, maintainer guidance, validation guide, and historical/design notes.
...
Use [`docs/validation.md`](docs/validation.md) for local restore, build, and test commands.
...
- [Tools.Numerics API and Behavior Reference](docs/api-and-behavior-reference.md) — normative deep dive covering per-type feature matrix, checked/unchecked semantics, parse/format contract details, byte-conversion guarantees, and maintenance invariants.
- [Tools.Numerics Wide-Integer Maintainer Guidance](docs/wide-integer-maintainer-guidance.md) — defect-pattern-oriented playbook distilled from recent Int*/UInt* implementation and follow-up fix cycles, with pre-merge checklists designed to prevent recurrence.
- [Int256 Refactoring Analysis (`c0f7869247c630aa066f6520f690920b76b0d745`)](docs/int256-c0f786-refactoring-analysis.md) — commit-scoped historical analysis covering behavior preservation, performance implications, and readability trade-offs for the Int256 simplification pass.
- [Integral Family Shared-Fragment Extraction Analysis](docs/integral-shared-fragment-analysis.md) — scenario-driven analysis of extraction opportunities spanning all six integral types, signed/unsigned families, and per-bitness pairs.
- [Bitness Code Generation Readiness and Design](docs/bitness-code-generation-readiness-and-design.md) — generator-readiness assessment for future wider integer families.
