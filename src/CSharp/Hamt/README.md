...
- Scope: Project layout and validation entry points for `src/CSharp/Hamt`

`src/CSharp/Hamt` contains the .NET 10 C# preview workspace for `Tools.DataStructures.Hamt`, a persistent
