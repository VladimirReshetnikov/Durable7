...
- [Range-update sequence contract](range-update-sequence.md) specifies the static tag/action algebra,
  ...
  `RangeUpdateSequence<TElement, TMeasure, TTag, TOps>`. Its focused and FingerTree-project gates
  are green in Debug and Release; the repository-wide C# solution gate remains pending.
