...
private fun listExamplesMatchWolframSurface() {
...
private fun associationOrderingExamplesMatchWolframRules() {
    checkAssociation(
...
public fun main() {
    val tests = listOf(
        "listExamplesMatchWolframSurface" to ::listExamplesMatchWolframSurface,
        "listGeneratedHistoriesPreserveSnapshots" to ::listGeneratedHistoriesPreserveSnapshots,
        "associationOrderingExamplesMatchWolframRules" to ::associationOrderingExamplesMatchWolframRules,
