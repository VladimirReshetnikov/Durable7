...
- [API notes](api-notes.md) records the measured-tree and RRB C API shapes, ownership rules, and
...
- [Tests README](../tests/README.md) maps the core and RRB CTest executables, named test cases, direct
