...
| [Tungsten](Tungsten/README.md) | Application-specific C17 leaf port of Tungsten `List` and `Association` | [public header](Tungsten/include/durable7/tungsten/tungsten.h), [tests](Tungsten/tests/tungsten_c_tests.c) | `.\build.ps1 -Workspace Tungsten -RunTests`; also run Release for native parity work |
