...
- [src/Kotlin/Hamt](src/Kotlin/Hamt/README.md) is a Kotlin/JVM persistent-map workspace. It provides CHAMP hash maps/sets, the managed Ctrie, Patricia integer maps/sets, and an immutable Merkle search-tree core whose strict codecs, SHA-256 policy framing, canonical topology, and `MST2` bytes match C# and Rust exactly.
