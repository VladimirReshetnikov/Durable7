...
- [src/Kotlin/FingerTree](src/Kotlin/FingerTree/README.md) is a Kotlin/JVM persistent measured-tree port of the FingerTree family. Its immutable measured AVL substrate provides structurally shared deque, measured sequence, sorted bag/set/map, cached-priority queue, max-high interval tree, positional/measured ropes, and measured text helpers; the reversible deque retains its specialized orientation-aware tree.
