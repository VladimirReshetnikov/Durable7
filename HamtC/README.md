...
- Scope: Project layout and validation entry points for `HamtC`

`HamtC` is the C17 port of the persistent HAMT collection family. It provides a type-erased C API
