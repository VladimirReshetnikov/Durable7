...
library under [`FingerTree/src/Tools.DataStructures.FingerTree`](../../../FingerTree/src/Tools.DataStructures.FingerTree)
...
1. The **middle subtree** — `MeasuredMiddle` / `LazyMeasuredMiddle._state`, published with
   ...
   ([`MeasuredMiddle.cs:101-110`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Measured/MeasuredMiddle.cs)).
2. The **deep node's own combined measure** — `DeepMeasuredTree._measureBox`, a *separate* field, published with a
   *separate* `Interlocked.CompareExchange`
   ([`MeasuredTreeLevels.cs:165-197`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Measured/MeasuredTreeLevels.cs)).
...
([`MeasuredTreeLevels.cs:165-166`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Measured/MeasuredTreeLevels.cs)).
...
([`TearableConcurrencyStressTests.cs:242-262`](../../../FingerTree/tests/Tools.DataStructures.FingerTree.Tests/TearableConcurrencyStressTests.cs)).
...
([`persistence-and-concurrency.md:88-123`](../../../FingerTree/docs/persistence-and-concurrency.md)), and the
...
([`MeasuredMiddle.cs:103,108`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Measured/MeasuredMiddle.cs);
[`MeasuredTreeLevels.cs:187,194`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Measured/MeasuredTreeLevels.cs)).
...
([`RopeChunk.cs:42-80`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/RopeChunk.cs), remark at
...
([`MeasuredMiddle.cs:117-129,184-188,214-218,248-252,280-284`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Measured/MeasuredMiddle.cs)).
...
([`FingerTree.cs:27-37`](../../../FingerTree/src/Tools.DataStructures.FingerTree/FingerTree.cs)).
...
([`MiddleTree.cs:77`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/MiddleTree.cs);
[`MeasuredMiddle.cs:108`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Measured/MeasuredMiddle.cs)).
...
([`Tree.cs:34,360-372,378`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Tree.cs)). Its only
...
([`MeasuredTree.cs:41-42,298-305`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Measured/MeasuredTree.cs);
[`MeasuredElements.cs:50-57`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Measured/MeasuredElements.cs)).
For the deque, `Tree<T, TChild>`'s middle is `Tree<T, Node<T, TChild>>`
([`Tree.cs:11-14,344`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Tree.cs)). Each deeper
...
[`ReversibleTree.cs:386,491,505`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Reversible/ReversibleTree.cs);
[`ReversibleDeque.cs:145,163`](../../../FingerTree/src/Tools.DataStructures.FingerTree/ReversibleDeque.cs)) become
...
1. **Order-independent measure + runtime comparer in the predicate** — `SortedBag/Set/Dictionary`. The measure is
   ...
   touches the comparer** ([`BuiltInMeasures.cs:158-169`](../../../FingerTree/src/Tools.DataStructures.FingerTree/BuiltInMeasures.cs)).
   ...
   [`SortedSet.cs:45,123,353`](../../../FingerTree/src/Tools.DataStructures.FingerTree/SortedSet.cs)). This is what
...
2. **Comparison baked into the measure monoid** — `PriorityQueue` and `IntervalTree`. Here `Combine` itself calls
   ...
   [`PriorityQueue.cs:36-43`](../../../FingerTree/src/Tools.DataStructures.FingerTree/PriorityQueue.cs)) and the
   interval tree's max-high (`CombineMax` uses `Comparer<T>.Default`,
   [`IntervalTree.cs:73-80`](../../../FingerTree/src/Tools.DataStructures.FingerTree/IntervalTree.cs)). C# is
   explicit that "a min-priority queue's `Combine` depends on the order, so unlike the sorted collections it
   **cannot accept a runtime comparer**" ([`PriorityQueue.cs:60-63`](../../../FingerTree/src/Tools.DataStructures.FingerTree/PriorityQueue.cs)).
...
3. **Static comparison policy** — the `MaxMeasure<T, TComparison>` / `MinMeasure<T, TComparison>` family and the
   ...
   ([`BuiltInMeasures.cs:178-222`](../../../FingerTree/src/Tools.DataStructures.FingerTree/BuiltInMeasures.cs);
   [`Comparisons.cs`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Comparisons.cs)). These map directly
...
([`ReversibleTree.cs:13-17`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Reversible/ReversibleTree.cs);
[`ReversibleDeque.cs:22`](../../../FingerTree/src/Tools.DataStructures.FingerTree/ReversibleDeque.cs)). Its deep
...
- **O(1) `reverse()` depends on *sharing* children, not deep-copying them.** `Mirror()` builds a new node that
  ...
  ([`ReversibleTree.cs:288`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Reversible/ReversibleTree.cs);
  [`ReversibleElements.cs:66,130`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Reversible/ReversibleElements.cs)).
...
- **Orientation-aware accessors allocate on the reversed path.** `LogicalChild`/`LogicalChildren` under reversal
  ...
  ([`ReversibleElements.cs:134-144`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Reversible/ReversibleElements.cs)).
...
- **Endpoint reads use an opposite-digit identity, not `Mirror`.** Reversed `First`/`Last` read cached
  ...
  ([`ReversibleTree.cs:273-276`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Reversible/ReversibleTree.cs);
  [`ReversibleElements.cs:124-127`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Reversible/ReversibleElements.cs)).
...
([`RopeChunk.cs:14-37`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/RopeChunk.cs)). The C++
...
- **A one-element slice pins the whole backing buffer** until `compact()` rebuilds it. This is the *reason*
  ...
  an eager copy.
- **`FromChunks` deliberately does not copy** caller memory ([`Rope.cs:347-364`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Rope.cs)).
...
re-walks the slice to recompute it ([`MeasuredRopeChunk.cs:23-27,52,74-81`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/MeasuredRopeChunk.cs)).
...
([`MeasuredRope.cs:480-502`](../../../FingerTree/src/Tools.DataStructures.FingerTree/MeasuredRope.cs)). An
...
arithmetic ([`Measures.cs:81`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Measures.cs)), and the
...
- **Ranks that can be absent need `std::optional<std::size_t>`, not a `-1` sentinel.** `IndexOf`/`IndexOfKey`
  return `-1` when absent ([`SortedSet.cs:122-126`](../../../FingerTree/src/Tools.DataStructures.FingerTree/SortedSet.cs));
...
- **`Try…(out …)` → optional / total result.** The read API is bool-returning `Try` methods with `out` values set
  to `default!` on the false path ([`FingerTree.cs:137-167,259-346`](../../../FingerTree/src/Tools.DataStructures.FingerTree/FingerTree.cs)).
  ...
  nothing matches, [`FingerTree.cs:335-339`](../../../FingerTree/src/Tools.DataStructures.FingerTree/FingerTree.cs)).
...
- **Value carriers need `operator==` (and sometimes `std::hash`); containers must not.** The public
  ...
  equality ([`FingerTreeDeque.cs:38-40`](../../../FingerTree/src/Tools.DataStructures.FingerTree/FingerTreeDeque.cs));
...
- **Indexable types keep `operator[]`/`at`.** `FingerTreeDeque<T>` is `IReadOnlyList<T>` with an O(log min(i+1,
  ...
  ([`FingerTreeDeque.cs:56,112-120`](../../../FingerTree/src/Tools.DataStructures.FingerTree/FingerTreeDeque.cs);
  [`SortedSet.cs:109-117`](../../../FingerTree/src/Tools.DataStructures.FingerTree/SortedSet.cs)). The plan's
...
- **Most of the library iterates by eager materialization, not a lazy walk.** `FingerTree.GetEnumerator` and
  ...
  ([`FingerTree.cs:350-367`](../../../FingerTree/src/Tools.DataStructures.FingerTree/FingerTree.cs)), and the
  ...
  both operands first ([`SortedSet.cs:355-403`](../../../FingerTree/src/Tools.DataStructures.FingerTree/SortedSet.cs))
...
- **Tearable concurrent-first-read test (H-adjacent).** Milestone 3 says only "concurrent first-force read tests."
  ...
  *both element and measure*, with (a) many-thread reads of one immutable tree, (b) concurrent *first* reads of a
  ...
  retained base ([`TearableConcurrencyStressTests.cs`](../../../FingerTree/tests/Tools.DataStructures.FingerTree.Tests/TearableConcurrencyStressTests.cs)).
...
- **Complexity guards** (allocation-flatness, no-force endpoint reads, comparer-call counts, size-independent
  ...
  ([`FingerTreeDequeComplexityGuardTests.cs`](../../../FingerTree/tests/Tools.DataStructures.FingerTree.Tests/FingerTreeDequeComplexityGuardTests.cs);
  [`AllocationFreeReadTests.cs`](../../../FingerTree/tests/Tools.DataStructures.FingerTree.Tests/AllocationFreeReadTests.cs);
  [`ZeroClosureNamedOpTests.cs`](../../../FingerTree/tests/Tools.DataStructures.FingerTree.Tests/ZeroClosureNamedOpTests.cs)).
...
- **`try_locate` vs `try_split_find` equivalence across every threshold** ([`TryLocateTests.cs`](../../../FingerTree/tests/Tools.DataStructures.FingerTree.Tests/TryLocateTests.cs))
...
- **"Concat forces both middles, breaking the lazy bound"** — `Glue` does force both operand middles
  ([`MeasuredTree.cs:139`](../../../FingerTree/src/Tools.DataStructures.FingerTree/Internal/Measured/MeasuredTree.cs)),
