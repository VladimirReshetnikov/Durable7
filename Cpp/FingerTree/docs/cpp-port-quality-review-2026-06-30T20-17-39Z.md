...
- Audience: Vladimir Reshetnikov and future maintainers/agents of `Cpp/FingerTree`
...
Undocumented code is a repository-wide pattern across this port (none of the 23 public/detail
...
No `samples/` or `benchmarks/` directory exists under `Cpp/FingerTree/` (both are listed as
