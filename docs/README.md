...
- [Benchmark-independent next data structures (2026-07-14)](proposals/benchmark-independent-next-structures-2026-07-14.md) - detailed C# execution proposal after the Axis 1 and shipped Axis 2 tranches: `PersistentOrderedSet<T>` first, persistent-HAMT single-pass updates plus `PersistentHashBag<T>` second, and an algebra-law-gated persistent AVL `RangeUpdateSequence` as the next new core; frozen layouts, size tiers, GUID specialization, and other evidence- or consumer-gated work remain parked.
