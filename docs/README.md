...
- [Repository-wide persistent cursor design](proposals/repository-wide-persistent-cursor-design.md) - exhaustive applicability decisions and detailed designs for public cursors and private edit paths across every persistent family, including shared version/focus contracts, per-family context reconstruction, explicit exclusions, cross-language ownership, validation, and staged rollout; proposed surfaces are not shipment claims.
