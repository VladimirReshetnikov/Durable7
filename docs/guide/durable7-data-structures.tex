...
\epigraph{The old version is still there. That one sentence is the whole
...
\epigraph{A contract that only one implementation upholds is a comment.}{}
...
\begin{center}
\small
\begin{tabularx}{\linewidth}{@{}L{0.13\linewidth}Y@{}}
\toprule
