...
- Reviewer: Codex
- Scope: Outcome and git-process review of the C# `FingerTree` data-structure library port to `Cpp/FingerTree`
...
- `FingerTree/README.md` and `FingerTree/docs/README.md`.
- `FingerTree/docs/api-specification.md`, with targeted checks against C# source and tests.
- `Cpp/FingerTree/README.md`.
- `Cpp/FingerTree/docs/README.md`.
- `Cpp/FingerTree/docs/port-plan.md`.
- `Cpp/FingerTree/docs/port-plan-editorial-notes.md`.
- `Cpp/FingerTree/docs/implementation-notes.md`.
- `Cpp/FingerTree/docs/api-notes.md`.
- `Cpp/FingerTree/docs/validation.md`.

Source reviewed:

- C++ public headers under `Cpp/FingerTree/include/tools/data_structures/finger_tree`.
...
- C++ tests under `Cpp/FingerTree/tests`.
...
- Reconstructed the C++ path history with `git log -- Cpp/FingerTree`.
...
- Compiled and ran a small out-of-tree C++ consumer using only the public aggregate header and `Cpp/FingerTree/include`.
...
- `Cpp/FingerTree/docs/port-plan.md:256-259` says `try_locate` is the exception to optional-shaped `Try` results:
  on a miss it must still return the whole-tree `measure_before`.
- `Cpp/FingerTree/docs/port-plan.md:418-423` repeats this with a total `locate_result` whose boundary element is
  optional.
- `Cpp/FingerTree/docs/port-plan.md:291` lists total `try_locate(predicate) -> locate_result<T, measure_type>` in
  the public surface checklist.
- `Cpp/FingerTree/include/tools/data_structures/finger_tree/measured_finger_tree.hpp:169-178` instead implements:
...
- `Cpp/FingerTree/docs/port-plan.md:797-804` requires tearable concurrent-first-read and stateful command-sequence
  tests for the measured tree.
- `Cpp/FingerTree/docs/port-plan.md:825-828` requires command-sequence and complexity guards for the deque.
- `Cpp/FingerTree/docs/port-plan.md:851-854` requires persistence and allocation/operation-count guards for
  derived collections.
- `Cpp/FingerTree/docs/port-plan.md:871-872` requires randomized reversible histories plus command sequences and
  O(1) reverse guards.
- `Cpp/FingerTree/docs/port-plan.md:896-899` requires measured-rope command tests and tearable concurrent-read
  tests.
...
- `Cpp/FingerTree/docs/port-plan.md:264-267` requires value/result carriers to default `operator==`, while warning
...
- `Cpp/FingerTree/docs/port-plan.md:432-434` says named operations should remain the safe public path.
- `Cpp/FingerTree/docs/port-plan.md:453-459` explicitly names the C# extension families to port:
...
- `Cpp/FingerTree/docs/port-plan.md:363-371` says to use forward iterators first and make `persistent_deque`
  genuinely lazy and allocation-free after construction.
- `Cpp/FingerTree/docs/port-plan.md:986-988` resolves iterator direction similarly.
...
- `Cpp/FingerTree/docs/port-plan.md:27-35` says the target is a stable header-first C++ library with tests,
  samples, and benchmarks, and that the first complete port preserves the Tour sample's core story.
- `Cpp/FingerTree/docs/port-plan.md:904-915` lists the intended C++ samples.
- `Cpp/FingerTree/docs/port-plan.md:917-930` lists the benchmark families.
- `Cpp/FingerTree/README.md:38` says `samples/` and `benchmarks/` are reserved for later milestones.
...
- `Cpp/FingerTree/CMakeLists.txt` defines an interface library and test target but no `install()`, export set,
  package config, version config, or installed-header validation.
- The out-of-tree consumer compiles only by manually passing `/I Cpp/FingerTree/include`.
...
- `Cpp/FingerTree/README.md:3` says "Initial C++ workspace".
- `Cpp/FingerTree/docs/validation.md:3` says "Initial validation guide" while its scope says stress and benchmark
...
- `Cpp/FingerTree/tests/CMakeLists.txt` builds all tests into `fingertree_smoke_tests` and registers one CTest
