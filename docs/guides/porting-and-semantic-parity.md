...
The policy-bound Merkle search tree has complete C#/Rust ports and C/Haskell/Kotlin core/wire ports.
All five pin the SHA-256 domain, key framing, empty digest, and canonical `MST2` block bytes. C# and
...
explicitly pending in C, Haskell, and Kotlin. Language-local ownership and callback shapes may
