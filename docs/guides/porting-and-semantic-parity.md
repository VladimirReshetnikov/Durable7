...
The policy-bound Merkle search tree has complete C#/Rust ports and C/C++/Haskell/Kotlin core/wire
ports. All six pin the SHA-256 domain, key framing, empty digest, and canonical `MST2` block bytes. C# and
...
explicitly pending in C, C++, Haskell, and Kotlin. Language-local ownership and callback shapes may
