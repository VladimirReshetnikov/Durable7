...
| [`src/Rust/FingerTree`](../../src/Rust/FingerTree/README.md) | `cargo test -p tools-data-structures-fingertree` | [Validation](../../src/Rust/FingerTree/docs/validation.md) | [Tests](../../src/Rust/FingerTree/tests/README.md) | Safe Rust checkpoint crate, structurally shared deque/reversible-deque/measured-tree/measured-rope tests plus persistent facade tests across sorted, priority, interval, rope, and text helpers |
