...
| [Kotlin FingerTree](../../src/Kotlin/FingerTree/README.md) | Kotlin/JVM executable test jar built by `src/Kotlin/build.ps1` | `.\build.ps1 -Workspace FingerTree` from `src/Kotlin` | [Tests README](../../src/Kotlin/FingerTree/tests/README.md) | Positional cursor boundary/nullability/branch/model/concurrency and shared-DAG `Int` overflow-atomicity gates; measured-AVL/RRB facades; DABA schedules and failure atomicity; canonical zip-zip rank vectors/topology/sharing/deep-chain invariants; Brodal comparison bounds and adversarial drains; PSQ rotations, pruning equations, nullable results, retained histories, sharing, and JVM concurrent readers |
