...
| [Rust FingerTree](../../src/Rust/FingerTree/README.md) | Cargo unit and representation-scale integration tests | `.\test.ps1 -Workspace FingerTree` from `src/Rust` | [Tests README](../../src/Rust/FingerTree/tests/README.md) | Structurally shared persistent-family tests, DABA histories/atomicity/reclamation, canonical zip-zip vectors/invariants, Brodal fused-shape/bound gates, and PSQ AVL/pruning/non-`Clone`/model/sharing/concurrency audits |
