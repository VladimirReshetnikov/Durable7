...
| [Kotlin HAMT](../../src/Kotlin/Hamt/README.md) | Kotlin/JVM executable test jar built by `src/Kotlin/build.ps1` | `.\build.ps1 -Workspace Hamt` from `src/Kotlin` | [Tests README](../../src/Kotlin/Hamt/tests/README.md) | HAMT/Ctrie/Patricia behavior plus exact Merkle wire, strict codecs, histories, adversarial levels, sharing, ranges/diff, retained model, mutation validation, and JVM readers |
