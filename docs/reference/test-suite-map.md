...
| [Haskell HAMT](../../src/Haskell/Hamt/README.md) | Cabal exit-code executable | `cabal test hamt-test` from `src/Haskell` | [Tests README](../../src/Haskell/Hamt/test/README.md) | Map/set behavior, collision shrink, strict mapping, one-pass adjust, receiver-policy relations, 100,000-entry construction, and `forkIO` readers |
...
| [Kotlin FingerTree](../../src/Kotlin/FingerTree/README.md) | Kotlin/JVM executable test jar built by `src/Kotlin/build.ps1` | `.\build.ps1 -Workspace FingerTree` from `src/Kotlin` | [Tests README](../../src/Kotlin/FingerTree/tests/README.md) | Measured-AVL facades, reversible deque, sharing/balance invariants, 5,000-command model, 100,000-element construction, recurring regressions, and JVM concurrent readers |
