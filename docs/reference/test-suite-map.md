...
| [Rust FingerTree](../../src/Rust/FingerTree/README.md) | Cargo unit tests inline across crate modules | `cargo test -p tools-data-structures-fingertree` | [Tests README](../../src/Rust/FingerTree/tests/README.md) | Structurally shared deque/reversible-deque/measured-tree/measured-rope tests plus checkpoint tests for sorted collections, priority queue, intervals, ropes, and text helpers |
