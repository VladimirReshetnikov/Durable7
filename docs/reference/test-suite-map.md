...
| [C HAMT](../../src/C/Hamt/README.md) | Three dependency-light native executables built by `build.ps1` | `.\build.ps1 -Workspace Hamt -RunTests` from `src/C` | [Tests README](../../src/C/Hamt/tests/README.md) | HAMT/Patricia models plus exact Merkle wire, bounded persistence, proofs, sync, nullable merge, all-limit and allocation/callback sweeps, reentrant store callbacks, and eight-thread readers/writers |
| [C++ HAMT](../../src/Cpp/Hamt/README.md) | Two dependency-free native suites plus a copied-header consumer built by `build.ps1` | `.\build.ps1 -Workspace Hamt -RunTests` from `src/Cpp` | [Tests README](../../src/Cpp/Hamt/tests/README.md) | CHAMP/Patricia models plus exact Merkle wire, bounded store/import, proof admission/tamper, sync, present-null and move-only merge, concurrency, analyzers, and package include closure |
...
| [Haskell HAMT](../../src/Haskell/Hamt/README.md) | Cabal exit-code executable | `.\test.ps1 -Workspace Hamt` from `src/Haskell` | [Tests README](../../src/Haskell/Hamt/test/README.md) | HAMT/Patricia plus pure SHA-256 and exact Merkle wire, immutable store/pack round trips, hostile closures, seven budgets, bomb-codec proofs, iterative sync, present/absent merge, retained roots, models, and `forkIO` readers |
...
| [Kotlin HAMT](../../src/Kotlin/Hamt/README.md) | Kotlin/JVM executable test jar built by `src/Kotlin/build.ps1` | `.\build.ps1 -Workspace Hamt` from `src/Kotlin` | [Tests README](../../src/Kotlin/Hamt/tests/README.md) | HAMT/Ctrie/Patricia behavior plus exact Merkle wire, retained histories, bounded load/import, all seven budgets, `MSP2` proofs, sync repair, atomic stores/conflicts, nullable merge states, and JVM readers |
...
| [Rust HAMT](../../src/Rust/Hamt/README.md) | Cargo unit and integration tests | `.\test.ps1 -Workspace Hamt` from `src/Rust` | [Tests README](../../src/Rust/Hamt/tests/README.md) | HAMT/Patricia models and readers plus Merkle golden wire, canonical closures, seven verification budgets, proofs, sync repair, atomic stores/import, non-`Clone` persistence, and typed merge |
