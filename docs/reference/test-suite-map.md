...
| [C# HAMT](../../src/CSharp/docs/Hamt/overview.md) | xUnit test project with CsCheck generated histories | `.\test.ps1` from `src/CSharp` | [Tests README](../../src/CSharp/tests/Tools.DataStructures.Hamt.Tests/README.md) | Library build, XML-doc gate, persistent map/set/bag examples and models, set and bag algebra, bag enumeration/API-shape gates, public map/set transient API shape, clean identity, consumed aliases, version-bound enumeration, mutation/publication failpoints, retained-base readers, and immutable-version publication |
| [C# FingerTree](../../src/CSharp/docs/FingerTree/overview.md) | xUnit test project with CsCheck, sample-smoke hooks, and default-duration stress tests | `.\test.ps1` from `src/CSharp` | [Tests README](../../src/CSharp/tests/Tools.DataStructures.FingerTree.Tests/README.md) | Library build, sample project build/smoke, positional and measured cursor API/model/cache/race coverage, broader model/property suites, and tearable concurrency stress |
...
| [C HAMT](../../src/C/Hamt/README.md) | Three dependency-light native executables built by `build.ps1` | `.\build.ps1 -Workspace Hamt -RunTests` from `src/C` | [Tests README](../../src/C/Hamt/tests/README.md) | HAMT/Patricia models; one-way map/set session lifecycle, alias-wide consumption, versioned iteration, receiver-policy relations, and allocation/retain failure atomicity; plus exact Merkle wire, bounded persistence, proofs, sync, nullable merge, reentrant callbacks, and eight-thread readers/writers |
| [C++ HAMT](../../src/Cpp/Hamt/README.md) | Two dependency-free native suites plus a copied-header consumer built by `build.ps1` | `.\build.ps1 -Workspace Hamt -RunTests` from `src/Cpp` | [Tests README](../../src/Cpp/Hamt/tests/README.md) | CHAMP/Patricia models; move-only one-way sessions, clean identity, generation-bound iteration, callback failure, throwing-policy-move invalidation, receiver-policy relations, and path-copy source isolation; plus exact Merkle wire, bounded store/import, proofs, sync, move-only merge, concurrency, analyzers, and package include closure |
...
| [Haskell HAMT](../../src/Haskell/Hamt/README.md) | Cabal exit-code executable | `.\test.ps1 -Workspace Hamt` from `src/Haskell` | [Tests README](../../src/Haskell/Hamt/test/README.md) | HAMT/Patricia plus `IO` map/set sessions covering clean identity, representatives, source isolation, consumption, deterministic models, and callback failure; pure SHA-256 and exact Merkle wire, immutable stores, hostile closures, seven budgets, proofs, sync, merge, retained roots, and `forkIO` readers |
...
| [Rust HAMT](../../src/Rust/Hamt/README.md) | Cargo unit and integration tests | `.\test.ps1 -Workspace Hamt` from `src/Rust` | [Tests README](../../src/Rust/Hamt/tests/README.md) | HAMT/Patricia models and readers plus consuming map/set sessions covering clean root/policy identity, active reads, representatives, receiver-policy relations, path-copy source isolation, clear, and a 4,096-command model; Merkle golden wire, seven budgets, proofs, sync, atomic stores/import, non-`Clone` persistence, and typed merge |
...
| [TypeScript](../../src/TypeScript/README.md) | Vitest examples plus fast-check model/property histories | `npm run validate` from `src/TypeScript` | [Tests README](../../src/TypeScript/test/README.md) | HAMT/transient/Patricia/Merkle, measured/FingerTree-derived families, RRB/canonical/Brodal/PSQ/DABA, rope cursors, Tungsten, and six fixed-width integer types; exact wire vectors and ESM declaration build |
