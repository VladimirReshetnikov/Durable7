...
| [C FingerTree](../../src/C/FingerTree/README.md) | Four focused native executables plus two sample smoke tests | `.\build.ps1 -Workspace FingerTree -RunTests` from `src/C` | [Tests README](../../src/C/FingerTree/tests/README.md) | Core/RRB/DABA tests plus canonical crypto vectors, erased-type identity, topology/model/sharing/deep-chain, callback/allocator atomicity, concurrent digest/refcount, lifecycle, sample smokes, and a benchmark executable |
| [C++ FingerTree](../../src/Cpp/FingerTree/README.md) | Local runner exposed as 19 subsystem CTests plus sample and installed-consumer integration | `.\build.ps1 -Workspace FingerTree -RunTests` from `src/Cpp` | [Tests README](../../src/Cpp/FingerTree/tests/README.md) | Header-first C++23 suite with canonical crypto/rank/topology/move-only/sharing/destruction gates, replay/shrinking, DABA failure gates, complexity guards, tearable concurrency, samples, and package relocation |
