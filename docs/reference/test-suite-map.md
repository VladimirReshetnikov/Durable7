...
| [C FingerTree](../../src/C/FingerTree/README.md) | Five focused native executables plus two sample smoke tests | `.\build.ps1 -Workspace FingerTree -RunTests` from `src/C` | [Tests README](../../src/C/FingerTree/tests/README.md) | Core/RRB/DABA tests; canonical crypto/type/topology/model gates; Brodal fused invariants, failpoint atomicity, retained histories, sharing, lifetimes, and readers; sample smokes; and a benchmark executable |
