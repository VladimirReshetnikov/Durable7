...
| [Rust FingerTree](../../src/Rust/FingerTree/README.md) | Cargo unit tests inline across crate modules | `.\test.ps1 -Workspace FingerTree` from `src/Rust` | [Tests README](../../src/Rust/FingerTree/tests/README.md) | Structurally shared persistent-family tests plus DABA Lite noncommutative/model histories, callback bounds and panic atomicity, chunk boundaries, deterministic reclamation, clear divergence, `!Send`/`!Sync`, and persistent-snapshot concurrency assertions |
