...
| [Haskell HAMT](../../src/Haskell/Hamt/README.md) | Cabal exit-code executable | `.\test.ps1 -Workspace Hamt` from `src/Haskell` | [Tests README](../../src/Haskell/Hamt/test/README.md) | HAMT/Patricia behavior plus pure SHA-256, exact Merkle golden domain/empty/root/block bytes, independent histories, wide blocks, path sharing, ranges/diff, 10,000-operation model, validation, and `forkIO` readers |
