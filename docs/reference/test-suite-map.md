...
| [C++ FingerTree](../../src/Cpp/FingerTree/README.md) | Local runner exposed as subsystem CTests plus sample and installed-consumer integration | `.\build.ps1 -Workspace FingerTree -RunTests` from `src/Cpp` | [Tests README](../../src/Cpp/FingerTree/tests/README.md) | Header-first C++23 suite with canonical crypto/rank/topology gates; Brodal and PSQ move-only/sharing/model/bound/exception/concurrency audits; replay/shrinking; DABA failures; complexity guards; samples; and package relocation |
