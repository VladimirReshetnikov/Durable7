...
| C++ HAMT | [src/Cpp/Hamt/docs/usage.md](../../src/Cpp/Hamt/docs/usage.md) and [Merkle guide](../../src/Cpp/Hamt/docs/merkle-search-tree.md) | Header inclusion, CHAMP/Patricia value semantics, custom policies, canonical Merkle codecs/topology, exact blocks, move-only handles, and diagnostics |
...
| Kotlin HAMT | [src/Kotlin/Hamt/docs/api-notes.md](../../src/Kotlin/Hamt/docs/api-notes.md) and [Merkle guide](../../src/Kotlin/Hamt/docs/merkle-search-tree.md) | HAMT/Ctrie/Patricia values plus canonical Merkle policies, codecs, persistent core, exact blocks, and executable validation |
...
| C++ HAMT | [API specification](../../src/Cpp/Hamt/docs/api-specification.md), [Merkle specification](../../src/Cpp/Hamt/docs/merkle-search-tree.md), and [aggregate header](../../src/Cpp/Hamt/include/Tools/DataStructures/Hamt/hamt.hpp) | C++ template contracts plus exact `MST2` Merkle core/wire and native ownership rules |
...
| Kotlin HAMT | [API notes](../../src/Kotlin/Hamt/docs/api-notes.md), [Merkle guide](../../src/Kotlin/Hamt/docs/merkle-search-tree.md), and [Merkle source](../../src/Kotlin/Hamt/src/tools/datastructures/hamt/MerkleSearchTree.kt) | Kotlin HAMT/Ctrie/Patricia APIs plus the exact `MST2` Merkle core/wire and managed-reference contracts |
...
| C++ HAMT | [Validation](../../src/Cpp/Hamt/docs/validation.md) | MSVC/GCC/Clang Debug/Release lanes, strict warnings/static analysis, CHAMP/Patricia models, Merkle wire/history/failure/concurrency coverage, and copied-header consumption |
...
| Kotlin HAMT | [Validation](../../src/Kotlin/Hamt/docs/validation.md) | Kotlin compiler bootstrap and deterministic HAMT/Ctrie/Patricia plus Merkle wire/history/model/sharing/validation/reader tests |
...
| C++ HAMT tests | [Tests README](../../src/Cpp/Hamt/tests/README.md) | Separate CHAMP/Patricia and Merkle executables plus copied aggregate-header golden consumer; codecs, exact wire, histories, sharing, move-only values, model, failures, validation, and readers |
...
| Kotlin HAMT tests | [Tests README](../../src/Kotlin/Hamt/tests/README.md) | Kotlin executable covering HAMT/Ctrie/Patricia semantics plus exact Merkle wire, histories, adversarial levels, sharing, ranges/diff, retained models, mutation checks, and readers |
