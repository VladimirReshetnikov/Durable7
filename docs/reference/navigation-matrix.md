...
| Edit or navigate a rope through a version-bound cursor | [Shared cursor contract](semantic-contracts.md#ropes-measured-ropes-and-text) | [C# usage and zipper decisions](../../src/CSharp/docs/FingerTree/usage.md), [C++ positional checkpoint](../../src/Cpp/FingerTree/docs/usage.md), and language-local cursor tests |
