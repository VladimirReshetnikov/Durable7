...
| C FingerTree | [src/C/FingerTree/docs/usage.md](../../src/C/FingerTree/docs/usage.md) | C handle lifetime, canonical erased-type/rank policy, Brodal policy and failure atomicity, persistent updates, DABA ownership/allocator semantics, facades, and text ropes |
| C++ FingerTree | [src/Cpp/FingerTree/docs/usage.md](../../src/Cpp/FingerTree/docs/usage.md) | Aggregate include path, persistent values, policy-canonical zip-zip set, Brodal-Okasaki heap, DABA Lite ownership/exception constraints, ropes/text, and publication patterns |
...
| C FingerTree | [API notes](../../src/C/FingerTree/docs/api-notes.md), [canonical header](../../src/C/FingerTree/include/tools/data_structures/finger_tree/canonical_sorted_set.h), and [Brodal header](../../src/C/FingerTree/include/tools/data_structures/finger_tree/brodal_okasaki_heap.h) | C API shape, erased-type identity, fallible callbacks, canonical rank/digest/algebra contracts, Brodal ownership/failure semantics, and C++ port differences |
| C++ FingerTree | [API notes](../../src/Cpp/FingerTree/docs/api-notes.md), [canonical header](../../src/Cpp/FingerTree/include/tools/data_structures/finger_tree/canonical_sorted_set.hpp), and [Brodal header](../../src/Cpp/FingerTree/include/tools/data_structures/finger_tree/brodal_okasaki_heap.hpp) | C++ conventions, canonical crypto/policy/digest contracts, Brodal move-only representatives and comparator identity, DABA no-throw commit and deterministic clear semantics, and active C# differences |
...
| C FingerTree | [Validation](../../src/C/FingerTree/docs/validation.md) | CMake/CTest validation, canonical crypto/type-tag gates, Brodal failpoints/bounds/readers, DABA allocation/ownership gates, compiler/sanitizer matrix, sample smokes, and benchmarks |
| C++ FingerTree | [Validation](../../src/Cpp/FingerTree/docs/validation.md) | CMake/CTest validation, canonical rank/topology/sharing/move-only/destruction gates, Brodal bounds/models/concurrency, DABA failures, stress controls, crypto packaging, and benchmarks |
...
| C FingerTree tests | [Tests README](../../src/C/FingerTree/tests/README.md) | Core/RRB/DABA/canonical/Brodal executable map, including vectors/models/type tags/failpoints/readers, direct paths, and runner behavior |
...
| C++ FingerTree tests | [Tests README](../../src/Cpp/FingerTree/tests/README.md) | Native group map including canonical and Brodal vectors/models/concurrency/destruction, DABA failures, direct runner paths, packaging, and tearable stress controls |
