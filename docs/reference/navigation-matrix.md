...
| C# HAMT | [API specification](../../src/CSharp/docs/Hamt/api-specification.md) and [T2 shipment decision](../../src/CSharp/docs/Hamt/transient-t2-decision.md) | Normative C# HAMT map/set contract, including the optimized owner-token single-owner lifecycle and its evidence boundary |
