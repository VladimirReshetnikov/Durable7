...
| Edit or navigate a rope through a version-bound cursor | [Shared cursor contract](semantic-contracts.md#ropes-measured-ropes-and-text) | [C# usage and zipper decisions](../../src/CSharp/docs/FingerTree/usage.md), [C++ positional checkpoint](../../src/Cpp/FingerTree/docs/usage.md), [Rust positional checkpoint](../../src/Rust/FingerTree/docs/api-notes.md), and language-local cursor tests |
