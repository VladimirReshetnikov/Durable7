...
| C FingerTree | [src/C/FingerTree/docs/usage.md](../../src/C/FingerTree/docs/usage.md) | C handle lifetime, canonical erased-type/rank policy, Brodal/PSQ ownership and failure atomicity, persistent updates, explicit-lifetime positional rope cursor, DABA allocator semantics, facades, and text ropes |
...
| C FingerTree tests | [Tests README](../../src/C/FingerTree/tests/README.md) | Core/RRB/DABA/canonical/Brodal/PSQ executable map, including positional cursor ownership/boundaries/branches/model/readers, vectors/models/type tags/failpoints/readers, direct paths, and runner behavior |
