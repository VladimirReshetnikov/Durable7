...
positional cursor. C++, Kotlin, and Rust ship snapshot-plus-gap
...
claiming the C# zipper or its focus-local complexity; measured and text cursors remain unported in C.
...
| C | `ft_rope`, `ft_rope_cursor`, `ft_measured_rope`, `ft_text_rope`, `ft_line_column` | [usage guide](../../src/C/FingerTree/docs/usage.md), [public header](../../src/C/FingerTree/include/tools/data_structures/finger_tree/fingertree.h), [API notes](../../src/C/FingerTree/docs/api-notes.md) |
