...
Patricia maps/sets; C# and Kotlin/JVM own the managed Ctrie; C#, Kotlin/JVM, and Rust own complete
wire-compatible policy-bound Merkle search trees; and C, C++, and Haskell own the same canonical
core/wire tier.
