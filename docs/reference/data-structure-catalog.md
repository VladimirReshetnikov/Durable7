...
TypeScript, and Python expose persistent map `GetOrAdd`/`AddOrUpdate` operations that hash once,
descend once, and invoke exactly one selected factory without a retry loop. Those three languages
also ship persistent hash bags with positive 32-bit per-class multiplicities, widened expanded
counts, receiver-policy multiset algebra, and stored-representative recovery. C# uses a checked
`long` total, TypeScript uses `bigint`, and Python uses `int`. C++ and Rust expose construction-only
...
| C++ | `persistent_hash_map<Key, T, Hash, KeyEqual, ValueEqual>`, its construction-only `bulk_builder`, and nested `transient`; `persistent_hash_set<T, Hash, KeyEqual>` and nested `transient`; Patricia and Merkle families | [Workspace](../../src/Cpp/Hamt/README.md), [usage guide](../../src/Cpp/Hamt/docs/usage.md), [API spec](../../src/Cpp/Hamt/docs/api-specification.md), [Merkle core](../../src/Cpp/Hamt/docs/merkle-search-tree.md), [persistence specification](../../src/Cpp/Hamt/docs/merkle-persistence.md), [aggregate header](../../src/Cpp/Hamt/include/Tools/DataStructures/Hamt/hamt.hpp), [persistence](../../src/Cpp/Hamt/include/Tools/DataStructures/Hamt/merkle_persistence.hpp), [proofs and merge](../../src/Cpp/Hamt/include/Tools/DataStructures/Hamt/merkle_proofs.hpp) |
