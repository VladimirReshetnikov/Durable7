...
Patricia maps/sets; C# and Kotlin/JVM own the managed Ctrie; C#, Haskell, Kotlin/JVM, and Rust own
complete wire-compatible policy-bound Merkle search trees; and C and C++ own the same canonical
core/wire tier.
