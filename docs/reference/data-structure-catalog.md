...
| Language | Public entry points | Primary references |
| --- | --- | --- |
| C# | `PersistentHashMap<TKey, TValue>`, `PersistentHashSet<T>` | [Workspace](../../src/CSharp/docs/Hamt/overview.md), [usage guide](../../src/CSharp/docs/Hamt/usage.md), [API spec](../../src/CSharp/docs/Hamt/api-specification.md), [map source](../../src/CSharp/src/Tools.DataStructures.Hamt/PersistentHashMap.cs), [set source](../../src/CSharp/src/Tools.DataStructures.Hamt/PersistentHashSet.cs) |
...
| Kotlin | `PersistentHashMap<K, V>`, `PersistentHashSet<T>`, `HashPolicy<K>` | [Workspace](../../src/Kotlin/Hamt/README.md), [API notes](../../src/Kotlin/Hamt/docs/api-notes.md), [validation](../../src/Kotlin/Hamt/docs/validation.md), [source](../../src/Kotlin/Hamt/src/tools/datastructures/hamt/PersistentHamt.kt), [tests](../../src/Kotlin/Hamt/tests/README.md) |
...
| Kotlin | `PersistentDeque<T>`, `FingerTree<T, M>`, `MeasurePolicy<T, M>` | [Workspace](../../src/Kotlin/FingerTree/README.md), [API notes](../../src/Kotlin/FingerTree/docs/api-notes.md), [deque/measured source](../../src/Kotlin/FingerTree/src/tools/datastructures/fingertree/Core.kt), [tests](../../src/Kotlin/FingerTree/tests/README.md) |
...
| Kotlin | `SortedBag<T>`, `SortedSet<T>`, `SortedMap<K, V>` | [API notes](../../src/Kotlin/FingerTree/docs/api-notes.md), [source](../../src/Kotlin/FingerTree/src/tools/datastructures/fingertree/Sorted.kt) |
...
| Language | Public entry points | Primary references |
| --- | --- | --- |
| C# | `PriorityQueue<TElement, TPriority>` | [usage guide](../../src/CSharp/docs/FingerTree/usage.md), [source](../../src/CSharp/src/Tools.DataStructures.FingerTree/PriorityQueue.cs), [API spec](../../src/CSharp/docs/FingerTree/api-specification.md) |
