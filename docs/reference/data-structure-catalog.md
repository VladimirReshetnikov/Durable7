...
hash once, descend once, and invoke exactly one selected factory without a retry loop; sibling ports
follow only after the complete C# proposal stabilizes. All six languages
