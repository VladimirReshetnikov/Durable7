...
Patricia maps/sets; C# and Kotlin/JVM own the managed Ctrie; C#, C++, Haskell, Kotlin/JVM, and Rust
own complete wire-compatible policy-bound Merkle search trees; and C owns the same canonical
core/wire tier.
