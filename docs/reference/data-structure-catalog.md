...
Patricia maps/sets; C# and Kotlin/JVM own the managed Ctrie, C# and Rust own complete wire-compatible
policy-bound Merkle search trees, and C, C++, Haskell, and Kotlin/JVM own the same canonical
core/wire tier.
...
| C | `tds_hamt_map`, `tds_hamt_set`, hash/set policies, `tds_int_map`, `tds_int_set`, `tds_long_map`, `tds_long_set`, `tds_merkle_policy`, `tds_merkle_search_tree`, codec/type/allocator policies, digest/block/shape/diff/statistics views | [Workspace](../../src/C/Hamt/README.md), [usage guide](../../src/C/Hamt/docs/usage.md), [API spec](../../src/C/Hamt/docs/api-specification.md), [Merkle specification](../../src/C/Hamt/docs/merkle-search-tree.md), [CHAMP header](../../src/C/Hamt/include/Tools/DataStructures/Hamt/hamt.h), [Patricia header](../../src/C/Hamt/include/Tools/DataStructures/Hamt/patricia.h), [Merkle header](../../src/C/Hamt/include/Tools/DataStructures/Hamt/merkle_search_tree.h) |
| C++ | `persistent_hash_map<Key, T, Hash, KeyEqual, ValueEqual>`, `persistent_hash_set<T, Hash, KeyEqual>`, `persistent_int_map<T>`, `persistent_int_set`, `persistent_long_map<T>`, `persistent_long_set`, `merkle_search_tree<K, V>`, `merkle_search_tree_policy<K, V>`, canonical codecs/digests and block/shape/diff/statistics records | [Workspace](../../src/Cpp/Hamt/README.md), [usage guide](../../src/Cpp/Hamt/docs/usage.md), [API spec](../../src/Cpp/Hamt/docs/api-specification.md), [Merkle specification](../../src/Cpp/Hamt/docs/merkle-search-tree.md), [aggregate header](../../src/Cpp/Hamt/include/Tools/DataStructures/Hamt/hamt.hpp), [Merkle encoding](../../src/Cpp/Hamt/include/Tools/DataStructures/Hamt/merkle_encoding.hpp), [Merkle core](../../src/Cpp/Hamt/include/Tools/DataStructures/Hamt/merkle_search_tree.hpp) |
| Haskell | `HashMap k v`, `HashSet a`, `HashPolicy k`, `Hashable`, `IntMap32 v`, `IntMap64 v`, `IntSet32`, `IntSet64`, `MerkleSearchTree k v`, `MerkleCodec a`, `MerkleSearchTreePolicy k v` | [Workspace](../../src/Haskell/Hamt/README.md), [map source](../../src/Haskell/Hamt/src/Data/Structures/Hamt/HashMap.hs), [Patricia source](../../src/Haskell/Hamt/src/Data/Structures/Hamt/Patricia.hs), [Merkle guide](../../src/Haskell/Hamt/docs/merkle-search-tree.md), [encoding](../../src/Haskell/Hamt/src/Data/Structures/Hamt/MerkleEncoding.hs), [Merkle core](../../src/Haskell/Hamt/src/Data/Structures/Hamt/MerkleSearchTree.hs), [tests](../../src/Haskell/Hamt/test/README.md) |
| Kotlin | `PersistentHashMap<K, V>`, `PersistentHashSet<T>`, `HashPolicy<K>`, `ConcurrentHashTrie<K, V>`, `PersistentIntMap<V>`, `PersistentIntSet`, `PersistentLongMap<V>`, `PersistentLongSet`, `MerkleSearchTree<K, V>`, `MerkleSearchTreePolicy<K, V>`, `MerkleCodec<T>`, `MerkleDigest` | [Workspace](../../src/Kotlin/Hamt/README.md), [API notes](../../src/Kotlin/Hamt/docs/api-notes.md), [Merkle guide](../../src/Kotlin/Hamt/docs/merkle-search-tree.md), [validation](../../src/Kotlin/Hamt/docs/validation.md), [CHAMP source](../../src/Kotlin/Hamt/src/tools/datastructures/hamt/PersistentHamt.kt), [Ctrie source](../../src/Kotlin/Hamt/src/tools/datastructures/hamt/ConcurrentHashTrie.kt), [Patricia source](../../src/Kotlin/Hamt/src/tools/datastructures/hamt/PersistentPatricia.kt), [Merkle encoding](../../src/Kotlin/Hamt/src/tools/datastructures/hamt/MerkleEncoding.kt), [Merkle core](../../src/Kotlin/Hamt/src/tools/datastructures/hamt/MerkleSearchTree.kt), [tests](../../src/Kotlin/Hamt/tests/README.md) |
