...
- [Data structure catalog](data-structure-catalog.md) - cross-language catalog of repository-owned families, including the four newest derived persistent structures in all eight languages, public entry points, and primary references.
- [Derived structure catalog](derived-structure-catalog.md) - historical verified composition survey with current disposition notes for the now-shipped ordered map, hash multimap/relation, and earlier candidates; consult the data-structure catalog for authoritative shipped surface.
