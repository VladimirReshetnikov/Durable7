...
- [Frontier structure catalog](frontier-structure-catalog.md) - surveyed candidates beyond composition: new structure cores (including recent inventions), hybrid/adaptive representation tiers, and niche-specialized siblings, with verdicts, sequencing, and literature references; candidates only, not shipped surface.
