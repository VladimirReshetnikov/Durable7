...
- [Data structure catalog](data-structure-catalog.md) - cross-language catalog of repository-owned families, including the strict bimap and the current five-structure derived tranche in all eight languages, public entry points, and primary references.
