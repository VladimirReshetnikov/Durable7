...
- [Data structure catalog](data-structure-catalog.md) - cross-language catalog of repository-owned data-structure families, including the independently owned C# insertion-ordered set, public entry points, and primary references.
- [Derived structure catalog](derived-structure-catalog.md) - historical verified composition survey with current disposition notes for shipped HAMT work, the C# hash bag, and application-specific Tungsten realization; consult the data-structure catalog for authoritative shipped surface.
