...
- [Data structure catalog](data-structure-catalog.md) - cross-language catalog of repository-owned data-structure families, including the eight-language strict persistent bimap and independently owned insertion-ordered set, public entry points, and primary references.
- [Derived structure catalog](derived-structure-catalog.md) - historical verified composition survey with current disposition notes for shipped HAMT work, hash bags, strict bimaps, and the application-specific Tungsten realization; consult the data-structure catalog for authoritative shipped surface.
