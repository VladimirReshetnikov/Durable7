...
- Audience: Maintainers and AI agents navigating repository structure
- Scope: Durable cross-workspace reference material
...
- [Data structure catalog](data-structure-catalog.md) - cross-language catalog of repository-owned families, including the strict bimap and the current five-structure derived tranche in all nine languages, public entry points, and primary references.
- [Derived structure catalog](derived-structure-catalog.md) - historical verified composition survey with current disposition notes for shipped HAMT work, hash bags, strict bimaps, ordered maps, hash multimaps/relations, and earlier candidates; consult the data-structure catalog for authoritative shipped surface.
- [Frontier structure catalog](frontier-structure-catalog.md) - current-state record of shipped Axis 1/selected Axis 2 work plus remaining candidates beyond composition: new cores, hybrid/adaptive representation tiers, niche-specialized siblings, verdicts, sequencing, and literature references.
...
- [Semantic contracts](semantic-contracts.md) - shared behavior, ownership, policy, ordering, dual-index, and documentation obligations across repository-owned data structures.
